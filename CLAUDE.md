...
A pilot logbook web app — flight logging, dashboard, route map, duty tracker, pilot profiles (with de-duplication/merge), aviation-document tracking (with Transport Canada expiry math), CSV import/export, on-device (iOS) logbook scanning, a first-run onboarding wizard, and bug reporting.
